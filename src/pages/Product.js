      ...
      <>
            ...
            <div className="lg:flex lg:gap-[10vw] justify-center">
              <div className="flex gap-[20px] lg:gap-[2vw]">
                ...
                <div className="w-[70%] lg:w-[auto]">
                  ...
                  <p className="text-[12px] lg:text-[0.8vw] w-[100%] lg:w-[18vw] leading-snug">
                    Analyse AI provides comprehensive analytics tools tailored
                    to each domain's unique challenges, ensuring accurate and
                    relevant results.
                  </p>
                </div>
              </div>
              <div className="flex gap-[20px] lg:gap-[2vw] mt-[30px] lg:mt-[0]">
                ...
                <div className="w-[70%] lg:w-[auto]">
                  ...
                  <p className="text-[12px] lg:text-[0.8vw] w-[100%] lg:w-[18vw] leading-snug">
                    Benefit from domain-specific algorithms and AI-driven
                    analytics for precise, time-efficient, and cost-effective
                    outcomes.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="about-hero">
            <div
              className="about-hero-img pb-[10vw] pt-[100px] lg:pt-[0]"
