      ...
      <div className="bg-eclipse-dark relative lg:pb-[100px]">
        ...
        {/* <div>
          <img
            src={elipse4}
            alt=""
            className="absolute top-[7vw] right-[22.5vw] h-[7vw] w-[7vw] hidden lg:block"
          />
        </div> */}
        {/* <div>
          <img
            src={elipse2}
            alt=""
            className="absolute top-[65vh] w-[100%] hidden lg:block"
          />
        </div> */}
        <div
        ...
        <div className="containers">
          <div className="mx-auto pb-[200px] lg:pb-[10vw] pt-[200px] lg:pt-[0vw]">
            ...
            <div className="block lg:hidden text-[12px] mt-[30px] ">
              <p>
                With our integrated approach of{" "}
                <font className="text-gradient-blue ">Peparing,</font>
                <font className="text-gradient-blue ">
                  {" "}
                  processing,
                </font> and{" "}
                <font className="text-gradient-blue ">analyzing </font>satellite
                images, we provide a comprehensive solution for sucrose
                prediction in sugarcane farming. Our technology-driven approach
                enables farmers to make data-driven decisions, optimize crop
                management practices, and improve sugarcane yield and quality.
              </p>
            </div>
            <div
              className="hidden lg:block text-[1.3vw] leading-[2vw] mt-[-40vh] pl-[30vw]"
              id="howsub"
            >
              <p>
                With our integrated approach of{" "}
                <font className="text-gradient-blue font-extrabold">
                  Preparing,
                </font>
                <font className="text-gradient-blue font-extrabold">
                  {" "}
            ...
            <div className="gap-[50px] mt-[100px] lg:mt-[300px] lg:mb-[5vw] justify-center how-holder">
              <div className="how-img hidden lg:block mb-[10vw]" id="howlist">
                <div className="himg active">
                  <img
                    src={acquire}
                    alt=""
                    className="h-[30vw] w-[100%] rounded-[2vw]"
                  />
                </div>
                <div className="himg">
                  <img
              ...
              <div className="block lg:hidden">
                {listItemsData.map((item) => (
                  <div key={item.id}>
                    <div className="block lg:hidden rounded-[20px] w-[100%] h-[209px] bg-black"></div>
            ...
            <div className="flex-[3]">
              <div className="blue-gradient px-[2vw] py-[4vw] rounded-[1vw]">
                ...
                <p className="text-white text-[0.8vw] mt-[2vw]">
                  Modernize how you buy carbon credits. Get started with <br />
                  Arms 4 AI today.
                </p>
